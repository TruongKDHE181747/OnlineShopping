    ...
    <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style="position: absolute; width: 100%; height: 100%; min-height: 600px">
        <hr>
            <ul class="nav nav-pills flex-column mb-auto">
                <li>
                    <a href="../orderlist" class="nav-link text-white order-link <c:if test="${pageContext.request.requestURI.endsWith('list-order.jsp')}">active</c:if>">
                        <!-- Orders Icon -->
                ...
                <li>
                    <a href="../pendinglist" class="nav-link text-white order-link <c:if test="${pageContext.request.requestURI.endsWith('list-order-pending.jsp')}">active</c:if>">
