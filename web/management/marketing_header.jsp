...
<!-- START menu -->
<div class="col-md-2">
    <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style="position: absolute; width: 100%; height: 100%;">
        <hr>
            <ul class="nav nav-pills flex-column mb-auto">
                <li class="nav-item">
                    ...
                    <li>
                        <a href="#" class="nav-link text-white contract-link <c:if test="${pageContext.request.requestURI.endsWith('post')}">active</c:if>">
                            <!-- Post Icon -->
                    ...
                    <li>
                        <a href="#" class="nav-link text-white contract-link <c:if test="${pageContext.request.requestURI.endsWith('postfeedback')}">active</c:if>">
                        <!-- Post Feedback Icon -->
