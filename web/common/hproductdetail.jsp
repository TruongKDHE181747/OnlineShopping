                ...
                <div class="row">
                    <div class="col-lg-3 col-md-3">
                        <div class="header__logo">
                            <a href="../homeslider"><img src="img/logo.png" alt=""></a>
                        </div>
                    </div>
            ...
            <div class="product__details__pic">
                <div class="container">
                    ...
                    <%
                     ...
                     List<ProductFeedback> pfList = (List<ProductFeedback>)session.getAttribute("dpfList");
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane" id="tabs-6" role="tabpanel">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="product__item row" style="margin: 24px 0;">
                                                    <div style="height: 120px" class="product__item__pic set-bg col-md-2" data-setbg="../product_img/at1.1.jpg">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="product__item row" style="margin: 24px 0;">
                                                    <div style="height: 120px" class="product__item__pic set-bg col-md-2" data-setbg="img/product/product-1.jpg">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="product__pagination">
                                                    ...
                                                    for (int j = 0; j < 2; j++) {
                                                    %>
                                                    <a class="<%=j==1?"active":""%>" href="../pagination?cpage=<%=j%>"><%=j+1%> </a>
                                                    <%
                                                        }
                                                    %>
                                                </div>
