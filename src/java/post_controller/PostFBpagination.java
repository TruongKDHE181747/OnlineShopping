 ...
 * @author Dell
 */
@WebServlet(name="PostFBpagination", urlPatterns={"/postfbpagination"})
public class PostFBpagination extends HttpServlet {
    ...
    throws ServletException, IOException {
        response.setContentType("text/html;charset=UTF-8");
         ...
         List<PostFeedback> pf3List = pfdao.getTop3FeedbackByPostId(ppostdetail.getPost_id()+"", cpage*3);
         session.setAttribute("pofpage", cpage);
