...
public class MarketingFilter implements Filter {
	...
	if (debug) log("MarketingFilter:DoBeforeProcessing");
	...
	*/
	...
	throws IOException, ServletException {
	if (debug) log("MarketingFilter:DoAfterProcessing");
	...
	*/
	...
	if (debug) log("MarketingFilter:doFilter()");
	...
	if (filterConfig == null) return ("MarketingFilter()");
